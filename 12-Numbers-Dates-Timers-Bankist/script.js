...
const startLogoutTimer = function () {
  ...
  //call the timer for every 1 sec
  tick();
...
// const calcDaysPas = (date1, date2) =>
//   Math.abs(date2 - date1) / (1000 * 60 * 60 * 24);

// const days1 = calcDaysPas(new Date(2037, 3, 4), new Date(2037, 3, 14));

// console.log(days1);
// console.log(new Date() - new Date(2037, 3, 4));
